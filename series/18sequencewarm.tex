...
\textbf{Note: Don't worry yet about the Taylor series for $e^x$ which is briefly mentioned at 5:50. We will come to this idea shortly.}
\youtube{i-PkHNpNuuA}

\section*{Online Texts}
\begin{itemize}
\item \link[OpenStax II 5.1: Sequences]{https://openstax.org/books/calculus-volume-2/pages/5-1-sequences}
\item \link[Ximera OSU: Sequences]{https://ximera.osu.edu/mooculus/calculus2/sequences/titlePage}
\item \link[Community Calculus 11.1: Sequences]{https://www.whitman.edu/mathematics/calculus_online/section11.01.html}
\end{itemize}
