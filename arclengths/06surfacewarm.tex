...
\begin{itemize}
\item \link[OpenStax II 2.4: Surface Area]{https://openstax.org/books/calculus-volume-2/pages/2-4-arc-length-of-a-curve-and-surface-area}
\item \link[Ximera OSU: Surface Area]{https://ximera.osu.edu/mooculus/calculus2/surfaceArea/titlePage}
\item \link[Community Calculus 9.10: Surface Area]{https://www.whitman.edu/mathematics/calculus_online/section09.10.html}
\end{itemize}
