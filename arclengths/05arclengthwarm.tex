...
\begin{itemize}
\item \link[OpenStax II 2.4 Arc Length]{https://openstax.org/books/calculus-volume-2/pages/2-4-arc-length-of-a-curve-and-surface-area}
\item \link[Ximera OSU: Arc Length]{https://ximera.osu.edu/mooculus/calculus2/lengthOfCurves/titlePage}
\item \link[Community Calculus: Arc Length]{https://www.whitman.edu/mathematics/calculus_online/section09.09.html}
\end{itemize}
