...
\choice{\(\displaystyle \frac{e^{x}}{\ln{x}} < \! \! < \ln{x} < \! \! < x^{x}\)} \choicebreak
...
\choice{\(\displaystyle x^{3} \ln{x} < \! \! < e^{x} < \! \! < \frac{e^{- x}}{\ln{x}}\)} \choicebreak
...
\choice{\(\displaystyle \frac{e^{- x}}{x^{3}} \ln{x} < \! \! < x^{3} e^{x} < \! \! < \left( \ln \frac{1}{x} \right)^2\)} \choicebreak
...
\choice{\(\displaystyle \frac{e^{- x}}{x^{3}} < \! \! < \frac{e^{- x}}{x^{3} \ln{x}} < \! \! < \frac{x^{3} e^{x}}{\ln{x}}\)} \choicebreak
