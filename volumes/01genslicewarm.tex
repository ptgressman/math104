...
\input{../preamble}
\title{Volume By General Cross Sections}
...
\begin{itemize}
\item \link[OpenStax II 2.2: Determining Volumes by Slicing]{https://openstax.org/books/calculus-volume-2/pages/2-2-determining-volumes-by-slicing}
\item \link[Ximera OSU: Accumulated Cross Sections]{https://ximera.osu.edu/mooculus/calculus2/accumulatedCrossSections/titlePage}
\end{itemize}
