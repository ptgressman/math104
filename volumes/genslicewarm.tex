...
\title{General Slicing By Cross Sections}
...
\begin{itemize}
\item Possible $x$-coordinates of points in the base range from a minimum value of $x = \answer{0}$ up to a maximum of $x = \answer{1}$.
